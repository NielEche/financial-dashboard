...
const Transactions = () => {
    ...
    return (
        <>
            ...
            <ul className='bg-white shadow-md rounded-4xl  p-6'>
                {transactions.map(transaction => (
                    <li key={transaction.id} className="flex justify-between py-2">
                        <div className="flex items-center">
                            {transaction.type === 'card' && <img src="/card.png" alt="Card" className="mr-2" width={55} height={55} />}
                            {transaction.type === 'paypal' && <img src="/paypal.png" alt="Paypal" className="mr-2" width={55} height={55} />}
                            {transaction.type === 'transfer' && <img src="/transfer.png" alt="Transfer" className="mr-2" width={55} height={55} />}
                            <div className='px-2'>
